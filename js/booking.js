...
export const SALON_WHATSAPP_NUMBER = '2250711084866'; // Numéro officiel de Blandine / Salon
export const SALON_OPEN_HOUR = 8;
export const SALON_OPEN_MINUTE = 30;
export const SALON_CLOSE_HOUR = 19;
export const SALON_CLOSE_MINUTE = 0;
 ...
 */
export function getWhatsAppBookingUrl(bookingData) {
